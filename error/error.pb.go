...
/*
Package errorservice is a generated protocol buffer package.
...
func init() {
	proto.RegisterType((*Request)(nil), "errorservice.Request")
	proto.RegisterType((*Response)(nil), "errorservice.Response")
	proto.RegisterType((*Error)(nil), "errorservice.Error")
}
...
func (c *errorServiceClient) TestError(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := grpc.Invoke(ctx, "/errorservice.ErrorService/TestError", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ErrorService_TestError_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/errorservice.ErrorService/TestError",
	}
...
var _ErrorService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "errorservice.ErrorService",
...
var fileDescriptor0 = []byte{
	...
	,
}
